...
public class GuiUpgradeTab extends BaseGuiTab {
	...
	public GuiUpgradeTab(StaticCoreContainerMenu container, InventoryComponent upgradesInventory) {
		this(container, upgradesInventory, new SpriteDrawable(StaticCoreGuiTextures.UPGRADE_TAB_ICON, 16, 16));
	}

	public GuiUpgradeTab(StaticCoreContainerMenu container, InventoryComponent upgradesInventory, IDrawable icon) {

...
public class StaticCoreItemBlockCustomRenderer extends StaticCoreItemBlock implements ICustomModelProvider {
	private final BiFunction<BlockEntityRenderDispatcher, EntityModelSet, BlockEntityWithoutLevelRenderer> renderer;

	public StaticCoreItemBlockCustomRenderer(Block block, BiFunction<BlockEntityRenderDispatcher, EntityModelSet, BlockEntityWithoutLevelRenderer> renderer) {

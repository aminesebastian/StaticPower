...
public class OreRegistryObject {
	...
	public OreRegistrationResult register(DeferredRegister<ConfiguredFeature<?, ?>> configuredFeatureRegistry,
			DeferredRegister<PlacedFeature> placedFeatureRegistry) {
		...
		RegistryObject<ConfiguredFeature<?, ?>> registeredConfiguredFeature = configuredFeatureRegistry.register(name,
				configuration);

		Supplier<PlacedFeature> testFeature = () -> new PlacedFeature(registeredConfiguredFeature.getHolder().get(),
				commonOrePlacement(veinsPerChunk, HeightRangePlacement.uniform(VerticalAnchor.absolute(minLevel),
						VerticalAnchor.absolute(maxLevel))));
		RegistryObject<PlacedFeature> registeredPlacedFeatue = placedFeatureRegistry.register(name + "_placed",
				testFeature);
	...
	public class OreRegistrationResult {
		...
		public OreRegistrationResult(RegistryObject<ConfiguredFeature<?, ?>> configuration,
				RegistryObject<PlacedFeature> feature) {

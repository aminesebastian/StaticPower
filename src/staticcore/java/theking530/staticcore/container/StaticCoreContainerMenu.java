...
public abstract class StaticCoreContainerMenu extends AbstractContainerMenu {
	public static final Logger LOGGER = LogManager.getLogger(StaticCoreContainerMenu.class);
	public static final int INVENTORY_COMPONENT_LOCK_MOUSE_BUTTON = 69;

	public final ContainerTypeAllocator<? extends StaticCoreContainerMenu, ?> allocator;
	...
	protected StaticCoreContainerMenu(ContainerTypeAllocator<? extends StaticCoreContainerMenu, ?> allocator, int id, Inventory inv) {
	...
	public StaticCoreContainerMenu duplicateForRevert(int windowId, Inventory inv, FriendlyByteBuf data) {
		try {
			Constructor<? extends StaticCoreContainerMenu> constructor = getClass().getConstructor(new Class[] { int.class, Inventory.class, FriendlyByteBuf.class });
	...
	public StaticCoreContainerMenu setOpener(ContainerOpener<?> opener) {
		this.opener = opener;
		return this;
	}

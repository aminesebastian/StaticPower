...
public class ContainerOpener<T extends StaticCoreContainerMenu> implements MenuProvider {
	private final IContainerFactory<T> containerFactory;
	private final Component name;
	private StaticCoreContainerMenu parent;
	...
	public ContainerOpener<T> fromParent(StaticCoreContainerMenu parent) {
		this.parent = parent;
		return this;
	}

	public StaticCoreContainerMenu getParent() {
		return parent;
	}

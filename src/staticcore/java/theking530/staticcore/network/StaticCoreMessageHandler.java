 ...
 *
 */
public class StaticCoreMessageHandler {
	private static final String PROTOCOL_VERSION = "1";
	public static final Logger LOGGER = LogManager.getLogger(StaticCoreMessageHandler.class);
	public static final SimpleChannel MAIN_PACKET_CHANNEL = NetworkRegistry.newSimpleChannel(new ResourceLocation(StaticCore.MOD_ID, "main"), () -> PROTOCOL_VERSION, PROTOCOL_VERSION::equals,

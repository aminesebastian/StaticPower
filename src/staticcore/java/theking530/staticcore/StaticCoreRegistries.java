...
public class StaticCoreRegistries {
	...
	public static final ResourceKey<Registry<CableDestination>> CABLE_DESTINATION_REGISTRY_KEY = key(
			"cable_destinations");
	public static final ResourceKey<Registry<CableNetworkModuleType>> CABLE_MODULE_REGISTRY_KEY = key("cable_modules");
	public static final ResourceKey<Registry<ServerCableCapabilityType<?>>> CABLE_CAPABILITY_REGISTRY_KEY = key(
			"cable_capabilities");
	...
	public static final ResourceKey<Registry<AttributeModifierType<?>>> ATTRIBUTE_MODIFIER_REGISTRY_KEY = key(
			"attribute_modifier");
	public static final ResourceKey<Registry<AttributeValueType<?>>> ATTRIBUTE_VALUE_REGISTRY_KEY = key(
			"attribute_value");
	public static final ResourceKey<Registry<ItemAttributeType>> ITEM_ATTRIBUTE_REGISTRY_KEY = key(
			"item_attribute_registry");

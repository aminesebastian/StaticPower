...
public class AbstractCableAttachmentContainer<T extends Item> extends StaticCoreContainerMenu {
	...
	protected AbstractCableAttachmentContainer(ContainerTypeAllocator<? extends StaticCoreContainerMenu, ?> allocator, int id, Inventory inv, ItemStack attachment,

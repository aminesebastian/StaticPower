...
public abstract class TierPowerConfiguration {
	...
	public TierPowerConfiguration(ForgeConfigSpec.Builder builder, String modId) {
		defaultPowerCapacity = builder.comment("The amount of power a block of this tier can store (in SW).").translation(modId + ".config." + "defaultPowerCapacity")
		...
		defaultInputVoltageRange = builder.comment("The input voltage range for powered blocks of this tier.")
				.translation(modId + ".config." + "defaultInputVoltageRange").define("DefaultInputVoltageRange", internalGetDefaultInputVoltageRange());
		defaultMaximumPowerInput = builder.comment("The maximum power a block of this tier can take (in SW/t).")
				.translation(modId + ".config." + "defaultMaximumPowerInput").define("DefaultMaximumPowerInput", getDefaultMaximumPowerInput());

		defaultOutputVoltage = builder.comment("The voltage a block outputs and uses internally when performing work.")
				.translation(modId + ".config." + "defaultOutputVoltage").define("DefaultOutputVoltage", getDefaultOutputVoltage());
		defaultMaximumPowerOutput = builder.comment("The maximum power a machine of this tier can use while performing work (in SW/t).")
				.translation(modId + ".config." + "defaultMaximumPowerOutput").define("DefaultMaximumPowerOutput", getDefaultMaximumPowerOutput());
		...
		transformerVoltageRange = builder.comment("The voltage range that can be handled by a transformer of this tier.")
				.translation(modId + ".config." + "transformerVoltageRange").define("TransformerVoltageRange", internalGetTransformerVoltageRange());
		...
		batteryCapacity = builder.comment("The amount of power that a battery of this tier can store (in SW).").translation(modId + ".config." + "batteryCapacity")
		...
		batteryMaximumPowerInput = builder.comment("The maximum power that a battery of this tier can accept (in SW/t).")
				.translation(modId + ".config." + "batteryMaximumPowerInput").define("BatteryMaximumPowerInput", getBatteryMaximumPowerInput());
		batteryMaximumPowerOutput = builder.comment("The maximum power that a battery of this tier can output (in SW/t).")
				.translation(modId + ".config." + "batteryMaximumPowerOutput").define("BatteryMaximumPowerOutput", getBatteryMaximumPowerOutput());
		maximumBatteryInputVoltage = builder.comment("The maximum input voltage of a batter of this tier.")
				.translation(modId + ".config." + "maximumBatteryInputVoltage").define("MaximumBatteryInputVoltage", internalGetMaximumBatteryInputVoltage());
		batteryOutputVoltage = builder.comment("The output voltage of a batter of this tier.").translation(modId + ".config." + "batteryOutputVoltage")
		...
		portableBatteryCapacity = builder.comment("The amount of power that can be stored in a portable battery of this tier (in SW).")
				.translation(modId + ".config." + "portableBatteryCapacity").define("PortableBatteryCapacity", getPortableBatteryCapacity());
		...
		portableBatteryMaximumPowerInput = builder.comment("The maximum amount of power a portable battery of this tier can input (in SW/t).")
				.translation(modId + ".config." + "portableBatteryMaximumPowerInput").define("PortableBatteryMaximumPowerInput", getPortableBatteryMaxPowerInput());
		portableBatteryOutputVoltage = builder.comment("The output voltage of a portable battery of this tier.")
				.translation(modId + ".config." + "portableBatteryOutputVoltage").define("BortableBatteryOutputVoltage", getPortableBatteryOutputVoltage());
		builder.pop();
		...
		solarPanelPowerGeneration = builder.comment("The amount of power generated by a solar panel of this tier per tick (in SW/t).")
				.translation(modId + ".config." + "solarPanelPowerGeneration").define("SolarPanelPowerGeneration", this.getSolarPanelPowerGeneration());
		solarPanelPowerStorage = builder.comment("The amount of power a solar panel of this tier can store (in SW).")
				.translation(modId + ".config." + "solarPanelPowerStorage").define("SolarPanelPowerStorage", this.getSolarPanelPowerStorage());
		builder.pop();
	}

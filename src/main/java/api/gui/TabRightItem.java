...
public class TabRightItem extends Gui {
	...
	public TabRightItem(int guiLeft, int guiTop, int width, int height, int xPos, int yPos, ResourceLocation texture, Item item) {

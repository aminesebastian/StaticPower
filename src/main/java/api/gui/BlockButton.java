...
public class BlockButton extends Gui implements MouseListener{
	...
	public BlockButton(int guiLeft, int guiTop, int width, int height, int xPos, int yPos, Block block) {
	...
	public void playSound() {
		if(TIMER == 1) {
			if(TILE_ENTITY != null) {
				//TILE_ENTITY.getWorld().playSound(TILE_ENTITY.xCoord, TILE_ENTITY.yCoord, TILE_ENTITY.zCoord, "gui.button.press", 0.4F, 1.0F, CLICKED); 
			}
		}
	}

...
@OnlyIn(Dist.CLIENT)
public class TextField extends AbstractGui {
	...
	public TextField(int p_i1032_4_, int p_i1032_5_) {
		...
		this.FONT_RENDERER = Minecraft.getInstance().fontRenderer;
	}
	...
	public void mouseClicked(int p_146192_1_, int p_146192_2_, int p_146192_3_) {
		...
		if (this.isFocused && p_146192_3_ == 0) {
			...
			String s = this.FONT_RENDERER.trimStringToWidth(this.text.substring(this.lineScrollOffset), this.getWidth());
			this.setCursorPosition(this.FONT_RENDERER.trimStringToWidth(s, l).length() + this.lineScrollOffset);
		}
	}
	...
	public void drawTextBox(int xPos, int yPos) {
		...
		if (this.getVisible()) {
			if (this.getEnableBackgroundDrawing()) {
				...
				// + 1, this.yPosition + this.height + 1, -6250336);
			...
			if (s.length() > 0) {
				...
				j1 = this.FONT_RENDERER.drawStringWithShadow(s1, l, i1, i);
			}
			...
			if (s.length() > 0 && flag && j < s.length()) {
				this.FONT_RENDERER.drawStringWithShadow(s.substring(j), j1, i1, i);
			}

			if (flag1) {
				if (flag2) {
					// AbstractGui.drawRect(k1, i1 - 1, k1 + 1, i1 + 1 +
					// this.FONT_RENDERER.FONT_HEIGHT, -3092272);
				} else {
					this.FONT_RENDERER.drawStringWithShadow("_", k1, i1, i);
				}
			}

			if (k != j) {
				int l1 = l + this.FONT_RENDERER.getStringWidth(s.substring(0, k));
				this.drawCursorVertical(k1, i1 - 1, l1 - 1, i1 + 1 + this.FONT_RENDERER.FONT_HEIGHT);
			}
		}
	}
	...
	private void drawCursorVertical(int p_146188_1_, int p_146188_2_, int p_146188_3_, int p_146188_4_) {
		...
		tes.pos((double) p_146188_1_, (double) p_146188_4_, 0.0D);
		tes.pos((double) p_146188_3_, (double) p_146188_4_, 0.0D);
		tes.pos((double) p_146188_3_, (double) p_146188_2_, 0.0D);
		tes.pos((double) p_146188_1_, (double) p_146188_2_, 0.0D);
		tessellator.draw();
	...
	public void setSelectionPos(int p_146199_1_) {
		...
		if (this.FONT_RENDERER != null) {
			...
			int k = this.getWidth();
			String s = this.FONT_RENDERER.trimStringToWidth(this.text.substring(this.lineScrollOffset), k);
			int l = s.length() + this.lineScrollOffset;

			if (p_146199_1_ == this.lineScrollOffset) {
				this.lineScrollOffset -= this.FONT_RENDERER.trimStringToWidth(this.text, k, true).length();
			}

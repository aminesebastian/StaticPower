...
public class GuiPowerBarFromEnergyStorage extends AbstractGuiWidget {
	...
	public void renderBehindItems(int mouseX, int mouseY, float partialTicks) {
		...
		GuiPowerBarUtilities.drawPowerBar(ownerRelativePosition.getX(), ownerRelativePosition.getY() + getSize().getY(), getSize().getX(), getSize().getY(), 0.0f, energyStorage.getEnergyStored(), energyStorage.getMaxEnergyStored());
	}

...
public class DiamondHardenedDefenition extends AbstractAttributeDefenition<Boolean, BooleanAttributeModifier> {
	...
	public DiamondHardenedDefenition(ResourceLocation id) {
		super(ID, "attribute.staticpower.hardened_diamond", TextFormatting.AQUA, BooleanAttributeModifier.class);
		baseValue = false;
	}

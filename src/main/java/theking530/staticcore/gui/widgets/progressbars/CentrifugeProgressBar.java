...
public class CentrifugeProgressBar extends AbstractProgressBar {
	...
	public void renderBehindItems(MatrixStack matrix, int mouseX, int mouseY, float partialTicks) {
		...
		GuiDrawUtilities.drawTexturedModalRect(GuiTextures.CENTRIFUGE_PROGRESS_BAR, screenSpacePosition.getX(), screenSpacePosition.getY(), getSize().getX(), getSize().getY() * adjustedProgress, 0.0f, 0.0f, 1.0f,
				(0.5f * adjustedProgress));
		GL11.glPopMatrix();

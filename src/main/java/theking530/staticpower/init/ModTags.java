...
public class ModTags {
	...
	public static final Tag<Item> FARMING_AXE = createItemWrapper(
			new ResourceLocation(StaticPower.MOD_ID, "farming_axe"));
	public static final Tag<Item> FARMING_HOE = createItemWrapper(
			new ResourceLocation(StaticPower.MOD_ID, "farming_hoe"));
	public static final Tag<Item> SOLDERING_IRON = createItemWrapper(

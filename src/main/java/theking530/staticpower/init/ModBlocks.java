...
public class ModBlocks {
	...
	public static void init() {
		...
		// Machine Blocks
		StaticPowerRegistry.preRegisterBlock(MachineBlockIron = new StaticPowerCutoutBlock("machine_block_iron",
		...
		StaticPowerRegistry
				.preRegisterBlock(ConveyorFilteredHopper = new BlockConveyorHopper("conveyor_hopper_filtered", true));

		StaticPowerRegistry.preRegisterBlock(
				AluminiumHeatSink = new BlockHeatSink("heat_sink_aluminium", StaticPowerTiers.ALUMINIUM));
		StaticPowerRegistry
		...
		StaticPowerRegistry.preRegisterBlock(
				AluminiumHeatCable = new BlockHeatCable("cable_heat_aluminium", StaticPowerTiers.ALUMINIUM));

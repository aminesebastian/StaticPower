...
public class ModCableModules {
	private static final DeferredRegister<CableNetworkModuleType> MODULES = DeferredRegister.create(StaticPowerRegistries.CABLE_MODULE_REGISTRY, StaticPower.MOD_ID);
	...
	public static boolean doesNetworkSupportRedstoneAnyRedstoneModule(CableNetwork network) {
		...
		for (CableNetworkModuleType type : StaticPowerRegistries.CableModuleRegsitry().getValues()) {

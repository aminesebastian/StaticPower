...
public class ModRecipeTypes {
	...
	public static final RegistryObject<RecipeType<AutoSmithRecipe>> AUTO_SMITH_RECIPE_TYPE = TYPES.register(AutoSmithRecipe.ID, () -> new StaticPowerRecipeType<AutoSmithRecipe>());
	...
	public static final RegistryObject<RecipeType<CastingRecipe>> CASTING_RECIPE_TYPE = TYPES.register(CastingRecipe.ID, () -> new StaticPowerRecipeType<CastingRecipe>());
	public static final RegistryObject<RecipeType<CauldronRecipe>> CAULDRON_RECIPE_TYPE = TYPES.register(CauldronRecipe.ID, () -> new StaticPowerRecipeType<CauldronRecipe>());
	public static final RegistryObject<RecipeType<CentrifugeRecipe>> CENTRIFUGE_RECIPE_TYPE = TYPES.register(CentrifugeRecipe.ID,
			() -> new StaticPowerRecipeType<CentrifugeRecipe>());
	public static final RegistryObject<RecipeType<CondensationRecipe>> CONDENSATION_RECIPE_TYPE = TYPES.register(CondensationRecipe.ID,
			() -> new StaticPowerRecipeType<CondensationRecipe>());
	public static final RegistryObject<RecipeType<CoverRecipe>> COVER_RECIPE_TYPE = TYPES.register(CoverRecipe.ID, () -> new StaticPowerRecipeType<CoverRecipe>());
	public static final RegistryObject<RecipeType<CrucibleRecipe>> CRUCIBLE_RECIPE_TYPE = TYPES.register(CrucibleRecipe.ID, () -> new StaticPowerRecipeType<CrucibleRecipe>());
	public static final RegistryObject<RecipeType<EnchanterRecipe>> ENCHANTER_RECIPE_TYPE = TYPES.register(EnchanterRecipe.ID, () -> new StaticPowerRecipeType<EnchanterRecipe>());
	public static final RegistryObject<RecipeType<EvaporatorRecipe>> EVAPORATOR_RECIPE_TYPE = TYPES.register(EvaporatorRecipe.ID,
			() -> new StaticPowerRecipeType<EvaporatorRecipe>());
	public static final RegistryObject<RecipeType<FermenterRecipe>> FERMENTER_RECIPE_TYPE = TYPES.register(FermenterRecipe.ID, () -> new StaticPowerRecipeType<FermenterRecipe>());
	...
	public static final RegistryObject<RecipeType<FluidGeneratorRecipe>> FLUID_GENERATOR_RECIPE_TYPE = TYPES.register(FluidGeneratorRecipe.ID,
			() -> new StaticPowerRecipeType<FluidGeneratorRecipe>());
	public static final RegistryObject<RecipeType<FluidInfusionRecipe>> FLUID_INFUSION_RECIPE_TYPE = TYPES.register(FluidInfusionRecipe.ID,
			() -> new StaticPowerRecipeType<FluidInfusionRecipe>());
	public static final RegistryObject<RecipeType<FormerRecipe>> FORMER_RECIPE_TYPE = TYPES.register(FormerRecipe.ID, () -> new StaticPowerRecipeType<FormerRecipe>());
	public static final RegistryObject<RecipeType<FusionFurnaceRecipe>> FUSION_FURNACE_RECIPE_TYPE = TYPES.register(FusionFurnaceRecipe.ID,
	...
	public static final RegistryObject<RecipeType<RefineryRecipe>> REFINERY_RECIPE_TYPE = TYPES.register(RefineryRecipe.ID, () -> new StaticPowerRecipeType<RefineryRecipe>());
	...
	public static final RegistryObject<RecipeType<SolderingRecipe>> SOLDERING_RECIPE_TYPE = TYPES.register(SolderingRecipe.ID, () -> new StaticPowerRecipeType<SolderingRecipe>());
	public static final RegistryObject<RecipeType<SqueezerRecipe>> SQUEEZER_RECIPE_TYPE = TYPES.register(SqueezerRecipe.ID, () -> new StaticPowerRecipeType<SqueezerRecipe>());
	public static final RegistryObject<RecipeType<ThermalConductivityRecipe>> THERMAL_CONDUCTIVITY_RECIPE_TYPE = TYPES.register(ThermalConductivityRecipe.ID,
			() -> new StaticPowerRecipeType<ThermalConductivityRecipe>());
	public static final RegistryObject<RecipeType<TumblerRecipe>> TUMBLER_RECIPE_TYPE = TYPES.register(TumblerRecipe.ID, () -> new StaticPowerRecipeType<TumblerRecipe>());
	public static final RegistryObject<RecipeType<TurbineRecipe>> TURBINE_RECIPE_TYPE = TYPES.register(TurbineRecipe.ID, () -> new StaticPowerRecipeType<TurbineRecipe>());
	public static final RegistryObject<RecipeType<VulcanizerRecipe>> VULCANIZER_RECIPE_TYPE = TYPES.register(VulcanizerRecipe.ID,
			() -> new StaticPowerRecipeType<VulcanizerRecipe>());
	...
	public static final RegistryObject<RecipeType<HydroponicFarmingRecipe>> HYDROPONIC_FARMING_RECIPE_TYPE = TYPES.register(HydroponicFarmingRecipe.ID,
			() -> new StaticPowerRecipeType<HydroponicFarmingRecipe>());

...
public class ModOres {
	...
	public static final OreConfigBuilder Aluminium = registerOreGeneration(new OreConfigBuilder(ModBlocks.OreAluminium).setMaxLevel(80).setMinLevel(40).setMaxVeinSize(10).setRarity(15));

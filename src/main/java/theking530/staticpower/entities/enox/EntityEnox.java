...
public class EntityEnox extends Cow {
	...
	public static AttributeSupplier.Builder createAttributes() {
		return Mob.createMobAttributes().add(Attributes.MAX_HEALTH, 16.0D).add(Attributes.MOVEMENT_SPEED, (double) 0.30F);
	}
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(3, new TemptGoal(this, 1.1D, Ingredient.of(ModItems.EnergizedFruit.get()), false));
	}

	@Override
	public boolean isFood(ItemStack stack) {
		return stack.getItem() == ModItems.EnergizedFruit.get();
	}

...
public class TypeSmeep extends AbstractSpawnableMobType<EntitySmeep> {
	public TypeSmeep(String name) {
		super(name, Color.EIGHT_BIT_WHITE, new Color(54, 239, 88),
				EntityType.Builder.of(EntitySmeep::new, MobCategory.CREATURE).sized(0.9f, 1.3f));
	}

	public void registerAttributes(RegistryEvent.Register<EntityType<?>> event) {
		// TO-DO: DefaultAttributes.put(ModEntities.Smeep.getType(),
		// EntitySmeep.getAttributes().build());
	}

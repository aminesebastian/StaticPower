...
public class ModelSmeep extends QuadrupedModel<EntitySmeep> {
	...
	public ModelSmeep(ModelPart p_170903_) {
	...
	public void prepareMobModel(EntitySmeep p_103687_, float p_103688_, float p_103689_, float p_103690_) {
	...
	public void setupAnim(EntitySmeep p_103692_, float p_103693_, float p_103694_, float p_103695_, float p_103696_,
			float p_103697_) {

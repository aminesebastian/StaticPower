...
public class WorldUtilities {
	...
	public static ItemEntity dropItem(World worldIn, double x, double y, double z, ItemStack stack) {
		ItemEntity ItemEntity = new ItemEntity(worldIn, x, y, z, stack);
        worldIn.addEntity(ItemEntity);
        return ItemEntity;
    }
	public static ItemEntity dropItem(World worldIn, Direction direction, double x, double y, double z, ItemStack stack) {
	...
	public static ItemEntity dropItem(World worldIn, Direction facing, BlockPos pos, ItemStack stack) {

...
public class GuiBasicFarmer extends GuiContainer{
	...
	public void updateScreen() {
		int j = (width - xSize) / 2;
		int k = (height - ySize) / 2;
		SIDE_TAB.updateTab(width+37, height, xSize, ySize, fontRendererObj, FARMER);
		REDSTONE_TAB.updateTab(width+37, height, xSize, ySize, fontRendererObj, FARMER);
	...
	protected void drawGuiContainerForegroundLayer(int i, int j) {
		...
		fontRendererObj.drawString(radius, xSize / 2 - 31, 119, GUIUtilities.getColor(20, 20, 20));
		
		String growthBounus = "Growth Bonus Chance: " + (int)(((1f/(float)FARMER.GROWTH_BONUS_CHANCE))*100) + "%";	
		fontRendererObj.drawString(growthBounus, xSize / 2 +39, 119, GUIUtilities.getColor(20, 20, 20));
	...
	protected void drawGuiContainerBackgroundLayer(float f, int i, int j) {
		...
		//Energy Bar
		POWER_BAR.drawPowerBar(guiLeft + 27, guiTop + 68, 6, 60, 1);

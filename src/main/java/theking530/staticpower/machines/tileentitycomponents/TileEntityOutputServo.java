...
public class TileEntityOutputServo implements ITileEntityComponent{
	...
	public TileEntityOutputServo(TileEntity tileEntity, int outputTime, ItemStackHandler inventory, int... slots) {

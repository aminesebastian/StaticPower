...
public class EvaporationRecipeGenerator extends SPRecipeProvider<EvaporatorRecipe> {
	...
	protected void buildRecipes() {
		addRecipe("evaporated_mash", create(FluidIngredient.of(1, ModFluids.Mash.getTag()), new FluidStack(ModFluids.EvaporatedMash.getSource().get(), 1), 5, 100));
		addRecipe("steam", create(FluidIngredient.of(1, FluidTags.WATER), new FluidStack(ModFluids.Steam.getSource().get(), 10), 10, 100));

...
public class VulcanizerRecipeGenerator extends SPRecipeProvider<VulcanizerRecipe> {
	...
	protected void addRecipe(String nameOverride, FluidIngredient inputFluid, StaticPowerOutputItem output, MachineRecipeProcessingSection processing) {
		addRecipe(nameOverride, SPRecipeBuilder.create(new VulcanizerRecipe(null, StaticPowerIngredient.EMPTY, inputFluid, output, processing)));
	}

	protected void addRecipe(String nameOverride, StaticPowerIngredient inputItem, FluidIngredient inputFluid, StaticPowerOutputItem output,
			MachineRecipeProcessingSection processing) {
		addRecipe(nameOverride, SPRecipeBuilder.create(new VulcanizerRecipe(null, inputItem, inputFluid, output, processing)));
	}
}

...
public class BlockEntityFluidCable extends BlockEntityBase {
	...
	public static final BlockEntityTypeAllocator<BlockEntityFluidCable> TYPE_BASIC = new BlockEntityTypeAllocator<BlockEntityFluidCable>(
			(allocator, pos, state) -> new BlockEntityFluidCable(allocator, pos, state, 2.0f / 16.0f, false), ModBlocks.FluidCableBasic);
	@BlockEntityTypePopulator()
	public static final BlockEntityTypeAllocator<BlockEntityFluidCable> TYPE_ADVANCED = new BlockEntityTypeAllocator<BlockEntityFluidCable>(
			(allocator, pos, state) -> new BlockEntityFluidCable(allocator, pos, state, 2.0f / 16.0f, false), ModBlocks.FluidCableAdvanced);
	@BlockEntityTypePopulator()
	public static final BlockEntityTypeAllocator<BlockEntityFluidCable> TYPE_STATIC = new BlockEntityTypeAllocator<BlockEntityFluidCable>(
			(allocator, pos, state) -> new BlockEntityFluidCable(allocator, pos, state, 2.0f / 16.0f, false), ModBlocks.FluidCableStatic);
	@BlockEntityTypePopulator()
	public static final BlockEntityTypeAllocator<BlockEntityFluidCable> TYPE_ENERGIZED = new BlockEntityTypeAllocator<BlockEntityFluidCable>(
			(allocator, pos, state) -> new BlockEntityFluidCable(allocator, pos, state, 2.0f / 16.0f, false), ModBlocks.FluidCableEnergized);
	@BlockEntityTypePopulator()
	public static final BlockEntityTypeAllocator<BlockEntityFluidCable> TYPE_LUMUM = new BlockEntityTypeAllocator<BlockEntityFluidCable>(
			(allocator, pos, state) -> new BlockEntityFluidCable(allocator, pos, state, 2.0f / 16.0f, false), ModBlocks.FluidCableLumum);
	@BlockEntityTypePopulator()
	public static final BlockEntityTypeAllocator<BlockEntityFluidCable> TYPE_CREATIVE = new BlockEntityTypeAllocator<BlockEntityFluidCable>(
			(allocator, pos, state) -> new BlockEntityFluidCable(allocator, pos, state, 2.0f / 16.0f, false), ModBlocks.FluidCableCreative);

	@BlockEntityTypePopulator()
	public static final BlockEntityTypeAllocator<BlockEntityFluidCable> TYPE_INDUSTRIAL_BASIC = new BlockEntityTypeAllocator<BlockEntityFluidCable>(
	...
	public static final BlockEntityTypeAllocator<BlockEntityFluidCable> TYPE_INDUSTRIAL_ADVANCED = new BlockEntityTypeAllocator<BlockEntityFluidCable>(
			(allocator, pos, state) -> new BlockEntityFluidCable(allocator, pos, state, 3.5f / 16.0f, true), ModBlocks.IndustrialFluidCableAdvanced);
	@BlockEntityTypePopulator()
	public static final BlockEntityTypeAllocator<BlockEntityFluidCable> TYPE_INDUSTRIAL_STATIC = new BlockEntityTypeAllocator<BlockEntityFluidCable>(
			(allocator, pos, state) -> new BlockEntityFluidCable(allocator, pos, state, 3.5f / 16.0f, true), ModBlocks.IndustrialFluidCableStatic);
	@BlockEntityTypePopulator()
	public static final BlockEntityTypeAllocator<BlockEntityFluidCable> TYPE_INDUSTRIAL_ENERGIZED = new BlockEntityTypeAllocator<BlockEntityFluidCable>(
			(allocator, pos, state) -> new BlockEntityFluidCable(allocator, pos, state, 3.5f / 16.0f, true), ModBlocks.IndustrialFluidCableEnergized);
	@BlockEntityTypePopulator()
	public static final BlockEntityTypeAllocator<BlockEntityFluidCable> TYPE_INDUSTRIAL_LUMUM = new BlockEntityTypeAllocator<BlockEntityFluidCable>(
	...
	public static final BlockEntityTypeAllocator<BlockEntityFluidCable> TYPE_INDUSTRIAL_CREATIVE = new BlockEntityTypeAllocator<BlockEntityFluidCable>(
			(allocator, pos, state) -> new BlockEntityFluidCable(allocator, pos, state, 3.5f / 16.0f, true), ModBlocks.IndustrialFluidCableCreative);

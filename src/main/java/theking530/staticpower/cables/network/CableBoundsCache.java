...
public class CableBoundsCache {
	...
	public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext ctx) {
		...
		if (ctx.getEntity() != null) {
			output = addAttachmentOutline(pos, ctx.getEntity(), output);
		}
	 ...
	 * @return
	 */
	public @Nullable Direction getHoveredAttachmentDirection(BlockPos pos, Entity entity) {
	 ...
	 * @return
	 */
	protected VoxelShape addAttachmentOutline(BlockPos pos, Entity entity, VoxelShape shape) {
		...
		if (hoveredDirection != null && CableUtilities.getConnectionState(entity.getEntityWorld(), pos, hoveredDirection) == CableConnectionState.TILE_ENTITY) {
			if (!CableUtilities.isSideConnectionDisabled(entity.getEntityWorld(), pos, hoveredDirection)) {

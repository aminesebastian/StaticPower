...
public class AutoCraftingStepWidget extends AbstractGuiWidget {
	...
	public void renderForeground(int mouseX, int mouseY, float partialTicks) {
		...
		if (material.getMissingAmount() > 0) {
			GuiDrawUtilities.drawStringWithSize("Required: " + material.getAmountRequired(), screenSpacePosition.getXi() + 53, screenSpacePosition.getYi() + 7, 0.5f, Color.EIGHT_BIT_WHITE, true);
			GuiDrawUtilities.drawStringWithSize("Stored: " + material.getAmountStored(), screenSpacePosition.getXi() + 53, screenSpacePosition.getYi() + 12, 0.5f, Color.EIGHT_BIT_WHITE, true);
			...
			GuiDrawUtilities.drawStringWithSize("Missing: " + material.getMissingAmount(), screenSpacePosition.getXi() + 53.5f, screenSpacePosition.getYi() + 19.5f, 0.5f,
					new Color(75.0f, 25.0f, 0.0f, 255.0f), false);
			GuiDrawUtilities.drawStringWithSize("Missing: " + material.getMissingAmount(), screenSpacePosition.getXi() + 53, screenSpacePosition.getYi() + 19, 0.5f,
			...
			GuiDrawUtilities.drawStringWithSize("Stored: " + material.getAmountStored(), screenSpacePosition.getXi() + 53, screenSpacePosition.getYi() + 12, 0.5f, Color.EIGHT_BIT_WHITE, true);
			GuiDrawUtilities.drawColoredRectangle(screenSpacePosition.getXi() + 21, screenSpacePosition.getYi() + 14, 35.0f, 0.5f, 1.0f, Color.GREY);
			GuiDrawUtilities.drawStringWithSize("To Craft: " + material.getAmountToCraft(), screenSpacePosition.getXi() + 53, screenSpacePosition.getYi() + 19, 0.5f, Color.EIGHT_BIT_WHITE, true);
		} else {
			GuiDrawUtilities.drawStringWithSize("Stored: " + material.getAmountRequired(), screenSpacePosition.getXi() + 53, screenSpacePosition.getYi() + 11, 0.5f, Color.EIGHT_BIT_WHITE, true);
		}

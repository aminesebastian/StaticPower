package theking530.staticpower.logicgates.timer;
...
public class GuiTimer extends GuiContainer{
	...
	private TileEntityTimer P_TIMER;
	...
	protected void drawGuiContainerForegroundLayer(int i, int j) {
		String name = I18n.format(this.P_TIMER.getName());
		String info = "Pulse Every: " + CURRENT_SIGNAL + " Ticks";
	...
	protected void actionPerformed(GuiButton B) {
		...
		if(B.id == 5) {
			IMessage msg = new PacketTimer(CURRENT_SIGNAL, P_TIMER.getPos());
			P_TIMER.SPEED = CURRENT_SIGNAL;

...
public class GuiSolarPanel extends StaticPowerTileEntityGui<ContainerSolarPanel, TileEntitySolarPanel> {
	...
	protected DrawableWidget generatingWidget;
	protected DrawableWidget notGeneratingWidget;
	...
	public void initializeGui() {
		...
		registerWidget(generatingWidget = new DrawableWidget(51, 65, 20, 20, new SpriteDrawable(StaticPowerSprites.GREEN_CHECK, 16, 16)));
		registerWidget(notGeneratingWidget = new DrawableWidget(51, 65, 20, 20, new SpriteDrawable(StaticPowerSprites.ERROR, 16, 16)));

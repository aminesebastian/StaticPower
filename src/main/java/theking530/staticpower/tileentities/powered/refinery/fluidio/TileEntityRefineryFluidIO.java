package theking530.staticpower.tileentities.powered.refinery.fluidio;
...
public class TileEntityRefineryFluidIO extends BaseRefineryTileEntity implements IFluidHandler {
	@TileEntityTypePopulator()
	public static final BlockEntityTypeAllocator<TileEntityRefineryFluidIO> INPUT_TYPE = new BlockEntityTypeAllocator<TileEntityRefineryFluidIO>(
			(type, pos, state) -> new TileEntityRefineryFluidIO(type, pos, state, false), ModBlocks.RefineryFluidInput);

	@TileEntityTypePopulator()
	public static final BlockEntityTypeAllocator<TileEntityRefineryFluidIO> OUTPUT_TYPE = new BlockEntityTypeAllocator<TileEntityRefineryFluidIO>(
			(type, pos, state) -> new TileEntityRefineryFluidIO(type, pos, state, true), ModBlocks.RefineryFluidOutput);

	private final RefineryFluidInterface[] tankInterfaces;
	private final boolean outputMode;

	public TileEntityRefineryFluidIO(BlockEntityTypeAllocator<TileEntityRefineryFluidIO> type, BlockPos pos, BlockState state, boolean outputMode) {

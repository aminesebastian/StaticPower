...
import theking530.staticpower.tileentities.powered.refinery.boiler.BlockRefineryBoiler;
import theking530.staticpower.tileentities.powered.refinery.heatvent.TileEntityRefineryHeatVent;
import theking530.staticpower.tileentities.powered.refinery.tower.BlockRefineryTower;
import theking530.staticpower.tileentities.powered.refinery.tower.BlockRefineryTower.TowerPiece;
import theking530.staticpower.tileentities.utilities.MultiBlockCache;
import theking530.staticpower.tileentities.utilities.MultiBlockWrapper;
...
public class TileEntityRefineryController extends TileEntityMachine {
	...
	private void renderParticleEffects() {
		...
		for (MultiBlockWrapper<IRefineryBlockEntity> wrapper : multiBlockCache) {
			...
			} else if (wrapper.entity instanceof TileEntityRefineryHeatVent) {

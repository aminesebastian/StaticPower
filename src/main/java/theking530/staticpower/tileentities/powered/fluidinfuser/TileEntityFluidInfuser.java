...
public class TileEntityFluidInfuser extends TileEntityMachine {
	...
	public static final BlockEntityTypeAllocator<TileEntityFluidInfuser> TYPE = new BlockEntityTypeAllocator<TileEntityFluidInfuser>((type) -> new TileEntityFluidInfuser(),

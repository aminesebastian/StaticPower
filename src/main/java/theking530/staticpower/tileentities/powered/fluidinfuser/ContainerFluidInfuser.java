...
public class ContainerFluidInfuser extends StaticPowerTileEntityContainer<TileEntityFluidInfuser> {
	...
	public static final ContainerTypeAllocator<ContainerFluidInfuser, GuiFluidInfuser> TYPE = new ContainerTypeAllocator<>("machine_fluid_infuser", ContainerFluidInfuser::new, GuiFluidInfuser::new);

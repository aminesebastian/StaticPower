...
public class ContainerFluidGenerator extends StaticPowerTileEntityContainer<TileEntityFluidGenerator> {
	...
	public static final ContainerTypeAllocator<ContainerFluidGenerator, GuiFluidGenerator> TYPE = new ContainerTypeAllocator<>("machine_fluid_generator", ContainerFluidGenerator::new, GuiFluidGenerator::new);

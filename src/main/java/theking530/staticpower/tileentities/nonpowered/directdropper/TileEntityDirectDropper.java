...
public class TileEntityDirectDropper extends TileEntityConfigurable {
	...
	public TileEntityDirectDropper(BlockPos pos, BlockState state) {
		...
		registerComponent(pulseControl = new RedstonePulseReactorComponent("PulseControl", DROP_DELAY, this::drop)
	...
	protected boolean drop() {
		...
		ItemEntity itemEntity = new ItemEntity(getLevel(), getBlockPos().getX() + 0.5, getBlockPos().getY() - 0.5,
				getBlockPos().getZ() + 0.5, itemToDrop);

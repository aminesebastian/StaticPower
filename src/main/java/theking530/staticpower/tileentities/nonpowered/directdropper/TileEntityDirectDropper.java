...
public class TileEntityDirectDropper extends TileEntityConfigurable {
	...
	public static final BlockEntityTypeAllocator<TileEntityDirectDropper> TYPE = new BlockEntityTypeAllocator<TileEntityDirectDropper>((type) -> new TileEntityDirectDropper(),

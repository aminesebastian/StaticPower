	...
	private static void registerShapedRecipes() {		
		...
		for(MaterialSet set : MaterialSets.MATERIALS) {
			...
			RegisterHelper.addShapedRecipe("StaticPower_" + set.getName() + "BlockFromIngot", "StaticPower", new ItemStack(Item.getItemFromBlock(set.getBlock())), new Object[]{"XXX","XXX","XXX",
					'X', Craft.itemstack(set.getIngot())});
		}	
		...
		for(MaterialSet set : MaterialSets.MATERIALS) {
			...
			RegisterHelper.addShapedRecipe("StaticPower_" + set.getName() + "IngotFromNugget", "StaticPower", set.getIngot(), new Object[]{"XXX","XXX","XXX",
					'X', Craft.itemstack(set.getNugget())});
		}		
		...
		for(MaterialSet set : MaterialSets.MATERIALS) {
			...
			RegisterHelper.addShapedRecipe("StaticPower_" + set.getName() + "GearFromIngot", "StaticPower", set.getGear(), new Object[]{" X ","XSX"," X ",
					'X', Craft.itemstack(set.getIngot()), 'S', ingredientFromItem(Items.STICK)});
		}	
		...
		'X', Craft.itemstack(ItemMaterials.gemSapphire)});
		...
		'X', Craft.itemstack(ItemMaterials.gemRuby)});
		...
		'C', Craft.ore("plateCopper"), 'W', ingredientFromItem(ModItems.CopperCoil)});
		...
		'G', ingredientFromBlock((Blocks.GLASS)) , 'I', Craft.ore("plateIron"), 'P', ingredientFromBlock(Blocks.PISTON), 'M', ingredientFromBlock(ModBlocks.MachineBlock)});
		...
		'G', ingredientFromBlock((Blocks.GLASS)) , 'C', Craft.ore("plateCopper"), 'B', ingredientFromItem(Items.BUCKET), 'M', ingredientFromBlock(ModBlocks.MachineBlock)});
		...
		'E', Craft.itemstack(ItemMaterials.plateEnergized), 'D', ingredientFromBlock(Blocks.DIRT)});
		...
		'F', ingredientFromBlock(ModBlocks.PoweredFurnace), 'R', Craft.ore("plateCopper"), 'B', ingredientFromBlock(ModBlocks.MachineBlock), 'C', ingredientFromItem(ModItems.BasicCircuit), 'I', ingredientFromItem(ModItems.IOPort), 'H', ingredientFromBlock(ModBlocks.HeatingElement)});
		...
		'C', ingredientFromItem(ModItems.BasicCircuit), 'H', Craft.ore("plateCopper"), 'R', Craft.ore("plateGold"), 'M', ingredientFromBlock(ModBlocks.MachineBlock), 'B', ingredientFromItem(ModItems.BasicBattery)});
		...
		'S', Craft.itemstack(ItemMaterials.plateStatic), 'B', ingredientFromItem(ModItems.StaticBattery), 'M', ingredientFromBlock(ModBlocks.MachineBlock)});			
		...
		'S', Craft.itemstack(ItemMaterials.plateEnergized), 'B', ModItems.EnergizedBattery, 'M', ingredientFromBlock(ModBlocks.MachineBlock)});		
		...
		'S', Craft.itemstack(ItemMaterials.plateLumum), 'B', ingredientFromItem(ModItems.LumumBattery), 'M', ingredientFromBlock(ModBlocks.MachineBlock)});		
		...
		'S', Craft.itemstack(ItemMaterials.ingotStatic), 'C', ingredientFromBlock(Blocks.CHEST)});		
		...
		'P', Craft.ore("plateIron"), 'G', ingredientFromBlock(Blocks.GLASS_PANE)});			
		...
		'E', Craft.itemstack(ItemMaterials.ingotEnergized), 'C',  ingredientFromBlock(ModBlocks.StaticChest)});		
		...
		'L', Craft.itemstack(ItemMaterials.ingotLumum), 'C',  ingredientFromBlock(ModBlocks.EnergizedChest)});		
		...
		//Static Armor --------------------------------------------------------------------------------------------------
		RegisterHelper.addShapedRecipe("StaticPower_staticHelmet", "StaticPower", new ItemStack(ModArmor.StaticHelmet), new Object[]{"EEE", "EBE", "   ",  'E', Craft.itemstack(ItemMaterials.ingotStatic), 'B', ingredientFromItem(ModItems.StaticBattery)});
		RegisterHelper.addShapedRecipe("StaticPower_staticChestplate", "StaticPower", new ItemStack(ModArmor.StaticChestplate), new Object[]{"EBE", "EEE", "EEE",  'E', Craft.itemstack(ItemMaterials.ingotStatic), 'B', ingredientFromItem(ModItems.StaticBattery)});
		RegisterHelper.addShapedRecipe("StaticPower_staticLeggings", "StaticPower", new ItemStack(ModArmor.StaticLeggings), new Object[]{"EEE", "EBE", "E E",  'E', Craft.itemstack(ItemMaterials.ingotStatic), 'B', ingredientFromItem(ModItems.StaticBattery)});
		RegisterHelper.addShapedRecipe("StaticPower_staticBoots", "StaticPower", new ItemStack(ModArmor.StaticBoots), new Object[]{"   ", "EBE", "E E",  'E', Craft.itemstack(ItemMaterials.ingotStatic), 'B', ingredientFromItem(ModItems.StaticBattery)});		
		//Energized Armor --------------------------------------------------------------------------------------------------
		RegisterHelper.addShapedRecipe("StaticPower_energizedHelmet", "StaticPower", new ItemStack(ModArmor.EnergizedHelmet), new Object[]{"EEE", "EBE", "   ",  'E', Craft.itemstack(ItemMaterials.ingotEnergized), 'B', ingredientFromItem(ModItems.EnergizedBattery)});
		RegisterHelper.addShapedRecipe("StaticPower_energizedChestplate", "StaticPower", new ItemStack(ModArmor.EnergizedChestplate), new Object[]{"EBE", "EEE", "EEE",  'E', Craft.itemstack(ItemMaterials.ingotEnergized), 'B', ingredientFromItem(ModItems.EnergizedBattery)});
		RegisterHelper.addShapedRecipe("StaticPower_energizedLeggings", "StaticPower", new ItemStack(ModArmor.EnergizedLeggings), new Object[]{"EEE", "EBE", "E E",  'E', Craft.itemstack(ItemMaterials.ingotEnergized), 'B', ingredientFromItem(ModItems.EnergizedBattery)});
		RegisterHelper.addShapedRecipe("StaticPower_energizedBoots", "StaticPower", new ItemStack(ModArmor.EnergizedBoots), new Object[]{"   ", "EBE", "E E",  'E', Craft.itemstack(ItemMaterials.ingotEnergized), 'B', ingredientFromItem(ModItems.EnergizedBattery)});		
		//Lumum Armor --------------------------------------------------------------------------------------------------
		RegisterHelper.addShapedRecipe("StaticPower_lumumHelmet", "StaticPower", new ItemStack(ModArmor.LumumHelmet), new Object[]{"EEE", "EBE", "   ",  'E', Craft.itemstack(ItemMaterials.ingotLumum), 'B', ingredientFromItem(ModItems.LumumBattery)});
		RegisterHelper.addShapedRecipe("StaticPower_lumumChestplate", "StaticPower", new ItemStack(ModArmor.LumumChestplate), new Object[]{"EBE", "EEE", "EEE",  'E', Craft.itemstack(ItemMaterials.ingotLumum), 'B', ingredientFromItem(ModItems.LumumBattery)});
		RegisterHelper.addShapedRecipe("StaticPower_lumumLeggings", "StaticPower", new ItemStack(ModArmor.LumumLeggings), new Object[]{"EEE", "EBE", "E E",  'E', Craft.itemstack(ItemMaterials.ingotLumum), 'B', ingredientFromItem(ModItems.LumumBattery)});
		RegisterHelper.addShapedRecipe("StaticPower_lumumBoots", "StaticPower", new ItemStack(ModArmor.LumumBoots), new Object[]{"   ", "EBE", "E E",  'E', Craft.itemstack(ItemMaterials.ingotLumum), 'B', ingredientFromItem(ModItems.LumumBattery)});		
		
		//Copper Armor --------------------------------------------------------------------------------------------------
		RegisterHelper.addShapedRecipe("StaticPower_copperHelmet", "StaticPower", new ItemStack(ModArmor.CopperHelmet), new Object[]{"EEE", "E E", "   ",  'E', Craft.itemstack(ItemMaterials.ingotCopper)});
		RegisterHelper.addShapedRecipe("StaticPower_copperChestplate", "StaticPower", new ItemStack(ModArmor.CopperChestplate), new Object[]{"E E", "EEE", "EEE",  'E', Craft.itemstack(ItemMaterials.ingotCopper)});
		RegisterHelper.addShapedRecipe("StaticPower_copperLeggings", "StaticPower", new ItemStack(ModArmor.CopperLeggings), new Object[]{"EEE", "E E", "E E",  'E', Craft.itemstack(ItemMaterials.ingotCopper)});
		RegisterHelper.addShapedRecipe("StaticPower_copperBoots", "StaticPower", new ItemStack(ModArmor.CopperBoots), new Object[]{"   ", "E E", "E E",  'E', Craft.itemstack(ItemMaterials.ingotCopper)});		
		//Tin Armor --------------------------------------------------------------------------------------------------
		RegisterHelper.addShapedRecipe("StaticPower_tinHelmet", "StaticPower", new ItemStack(ModArmor.TinHelmet), new Object[]{"EEE", "E E", "   ",  'E', Craft.itemstack(ItemMaterials.ingotTin)});
		RegisterHelper.addShapedRecipe("StaticPower_tinChestplate", "StaticPower", new ItemStack(ModArmor.TinChestplate), new Object[]{"E E", "EEE", "EEE",  'E', Craft.itemstack(ItemMaterials.ingotTin)});
		RegisterHelper.addShapedRecipe("StaticPower_tinLeggings", "StaticPower", new ItemStack(ModArmor.TinLeggings), new Object[]{"EEE", "E E", "E E",  'E', Craft.itemstack(ItemMaterials.ingotTin)});
		RegisterHelper.addShapedRecipe("StaticPower_tinBoots", "StaticPower", new ItemStack(ModArmor.TinBoots), new Object[]{"   ", "E E", "E E",  'E', Craft.itemstack(ItemMaterials.ingotTin)});		
		//Lead Armor --------------------------------------------------------------------------------------------------
		RegisterHelper.addShapedRecipe("StaticPower_leadHelmet", "StaticPower", new ItemStack(ModArmor.LeadHelmet), new Object[]{"EEE", "E E", "   ",  'E', Craft.itemstack(ItemMaterials.ingotLead)});
		RegisterHelper.addShapedRecipe("StaticPower_leadChestplate", "StaticPower", new ItemStack(ModArmor.LeadChestplate), new Object[]{"E E", "EEE", "EEE",  'E', Craft.itemstack(ItemMaterials.ingotLead)});
		RegisterHelper.addShapedRecipe("StaticPower_leadLeggings", "StaticPower", new ItemStack(ModArmor.LeadLeggings), new Object[]{"EEE", "E E", "E E",  'E', Craft.itemstack(ItemMaterials.ingotLead)});
		RegisterHelper.addShapedRecipe("StaticPower_leadBoots", "StaticPower", new ItemStack(ModArmor.LeadBoots), new Object[]{"   ", "E E", "E E",  'E', Craft.itemstack(ItemMaterials.ingotLead)});		
		//Silver Armor --------------------------------------------------------------------------------------------------
		RegisterHelper.addShapedRecipe("StaticPower_silverHelmet", "StaticPower", new ItemStack(ModArmor.SilverHelmet), new Object[]{"EEE", "E E", "   ",  'E', Craft.itemstack(ItemMaterials.ingotSilver)});
		RegisterHelper.addShapedRecipe("StaticPower_silverChestplate", "StaticPower", new ItemStack(ModArmor.SilverChestplate), new Object[]{"E E", "EEE", "EEE",  'E', Craft.itemstack(ItemMaterials.ingotSilver)});
		RegisterHelper.addShapedRecipe("StaticPower_silverLeggings", "StaticPower", new ItemStack(ModArmor.SilverLeggings), new Object[]{"EEE", "E E", "E E",  'E', Craft.itemstack(ItemMaterials.ingotSilver)});
		RegisterHelper.addShapedRecipe("StaticPower_silverBoots", "StaticPower", new ItemStack(ModArmor.SilverBoots), new Object[]{"   ", "E E", "E E",  'E', Craft.itemstack(ItemMaterials.ingotSilver)});		
		//Platinum Armor --------------------------------------------------------------------------------------------------
		RegisterHelper.addShapedRecipe("StaticPower_platinumHelmet", "StaticPower", new ItemStack(ModArmor.PlatinumHelmet), new Object[]{"EEE", "E E", "   ",  'E', Craft.itemstack(ItemMaterials.ingotPlatinum)});
		RegisterHelper.addShapedRecipe("StaticPower_platinumChestplate", "StaticPower", new ItemStack(ModArmor.PlatinumChestplate), new Object[]{"E E", "EEE", "EEE",  'E', Craft.itemstack(ItemMaterials.ingotPlatinum)});
		RegisterHelper.addShapedRecipe("StaticPower_platinumLeggings", "StaticPower", new ItemStack(ModArmor.PlatinumLeggings), new Object[]{"EEE", "E E", "E E",  'E', Craft.itemstack(ItemMaterials.ingotPlatinum)});
		RegisterHelper.addShapedRecipe("StaticPower_platinumBoots", "StaticPower", new ItemStack(ModArmor.PlatinumBoots), new Object[]{"   ", "E E", "E E",  'E', Craft.itemstack(ItemMaterials.ingotPlatinum)});		
		//Aluminium Armor --------------------------------------------------------------------------------------------------
		RegisterHelper.addShapedRecipe("StaticPower_aluminiumHelmet", "StaticPower", new ItemStack(ModArmor.AluminiumHelmet), new Object[]{"EEE", "E E", "   ",  'E', Craft.itemstack(ItemMaterials.ingotAluminium)});
		RegisterHelper.addShapedRecipe("StaticPower_aluminiumChestplate", "StaticPower", new ItemStack(ModArmor.AluminiumChestplate), new Object[]{"E E", "EEE", "EEE",  'E', Craft.itemstack(ItemMaterials.ingotAluminium)});
		RegisterHelper.addShapedRecipe("StaticPower_aluminiumLeggings", "StaticPower", new ItemStack(ModArmor.AluminiumLeggings), new Object[]{"EEE", "E E", "E E",  'E', Craft.itemstack(ItemMaterials.ingotAluminium)});
		RegisterHelper.addShapedRecipe("StaticPower_aluminiumBoots", "StaticPower", new ItemStack(ModArmor.AluminiumBoots), new Object[]{"   ", "E E", "E E",  'E', Craft.itemstack(ItemMaterials.ingotAluminium)});		
		//Sapphire Armor --------------------------------------------------------------------------------------------------
		RegisterHelper.addShapedRecipe("StaticPower_sapphireHelmet", "StaticPower", new ItemStack(ModArmor.SapphireHelmet), new Object[]{"EEE", "E E", "   ",  'E', Craft.itemstack(ItemMaterials.gemSapphire)});
		RegisterHelper.addShapedRecipe("StaticPower_sapphireChestplate", "StaticPower", new ItemStack(ModArmor.SapphireChestplate), new Object[]{"E E", "EEE", "EEE",  'E', Craft.itemstack(ItemMaterials.gemSapphire)});
		RegisterHelper.addShapedRecipe("StaticPower_sapphireLeggings", "StaticPower", new ItemStack(ModArmor.SapphireLeggings), new Object[]{"EEE", "E E", "E E",  'E', Craft.itemstack(ItemMaterials.gemSapphire)});
		RegisterHelper.addShapedRecipe("StaticPower_sapphireBoots", "StaticPower", new ItemStack(ModArmor.SapphireBoots), new Object[]{"   ", "E E", "E E",  'E', Craft.itemstack(ItemMaterials.gemSapphire)});		
		//Ruby Armor --------------------------------------------------------------------------------------------------
		RegisterHelper.addShapedRecipe("StaticPower_rubyHelmet", "StaticPower", new ItemStack(ModArmor.RubyHelmet), new Object[]{"EEE", "E E", "   ",  'E', Craft.itemstack(ItemMaterials.gemRuby)});
		RegisterHelper.addShapedRecipe("StaticPower_rubyChestplate", "StaticPower", new ItemStack(ModArmor.RubyChestplate), new Object[]{"E E", "EEE", "EEE",  'E', Craft.itemstack(ItemMaterials.gemRuby)});
		RegisterHelper.addShapedRecipe("StaticPower_rubyLeggings", "StaticPower", new ItemStack(ModArmor.RubyLeggings), new Object[]{"EEE", "E E", "E E",  'E', Craft.itemstack(ItemMaterials.gemRuby)});
		RegisterHelper.addShapedRecipe("StaticPower_rubyBoots", "StaticPower", new ItemStack(ModArmor.RubyBoots), new Object[]{"   ", "E E", "E E",  'E', Craft.itemstack(ItemMaterials.gemRuby)});		

...
public class InfuserRecipes {
	...
	public static void registerInfusionRecipes() {
		...
		RegisterHelper.registerInfuserRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.ObsidianGlass)), new ItemStack(Item.getItemFromBlock(ModBlocks.StaticLamp)), new FluidStack(ModFluids.StaticFluid, 1000));
		...
		RegisterHelper.registerInfuserRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.BasicSolarPanel)), new ItemStack(Item.getItemFromBlock(ModBlocks.StaticSolarPanel)), new FluidStack(ModFluids.StaticFluid, 1000));
		RegisterHelper.registerInfuserRecipe(new ItemStack(ModItems.ApplePie), new ItemStack(ModItems.StaticPie), new FluidStack(ModFluids.StaticFluid, 50));
	...
	public static void oreDictionaryStack(String ore, Item output, FluidStack fluidStack) {
		for(int index = 0; index < OreDictionary.getOres(ore).size(); index++) {
			...
			RegisterHelper.registerInfuserRecipe(tempStack.copy(), new ItemStack(output), fluidStack); //We must use a copy here because we are storing in a hash map.
		}
	}
}

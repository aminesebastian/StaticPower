...
public class InfuserRecipes {
	...
	public static void registerInfusionRecipes() {
		...
		RegisterHelper.registerInfuserRecipe(CraftHelpers.ingredientFromItem(Items.IRON_INGOT), SPItemMaterial.ingotStatic, new FluidStack(ModFluids.StaticFluid, 250));
		RegisterHelper.registerInfuserRecipe(CraftHelpers.ingredientOre("dustIron"),  CraftHelpers.outputItemStack(SPItemMaterial.dustStatic), new FluidStack(ModFluids.StaticFluid, 250));
		RegisterHelper.registerInfuserRecipe(CraftHelpers.ingredientOre("plateIron"), CraftHelpers.outputItemStack(SPItemMaterial.plateStatic), new FluidStack(ModFluids.StaticFluid, 250));
		...
		RegisterHelper.registerInfuserRecipe(CraftHelpers.ingredientFromItemstack(SPItemMaterial.ingotStatic), CraftHelpers.outputItemStack(SPItemMaterial.ingotEnergized), new FluidStack(ModFluids.EnergizedFluid, 250));		
		RegisterHelper.registerInfuserRecipe(CraftHelpers.ingredientFromItemstack(SPItemMaterial.dustStatic), CraftHelpers.outputItemStack(SPItemMaterial.dustEnergized), new FluidStack(ModFluids.EnergizedFluid, 250));
		RegisterHelper.registerInfuserRecipe(CraftHelpers.ingredientFromItemstack(SPItemMaterial.plateStatic), CraftHelpers.outputItemStack(SPItemMaterial.plateEnergized), new FluidStack(ModFluids.EnergizedFluid, 250));
		...
		RegisterHelper.registerInfuserRecipe(CraftHelpers.ingredientFromItemstack(SPItemMaterial.ingotEnergized), CraftHelpers.outputItemStack(SPItemMaterial.ingotLumum), new FluidStack(ModFluids.LumumFluid, 250));		
		RegisterHelper.registerInfuserRecipe(CraftHelpers.ingredientFromItemstack(SPItemMaterial.dustEnergized), CraftHelpers.outputItemStack(SPItemMaterial.dustLumum), new FluidStack(ModFluids.LumumFluid, 250));
		RegisterHelper.registerInfuserRecipe(CraftHelpers.ingredientFromItemstack(SPItemMaterial.plateEnergized), CraftHelpers.outputItemStack(SPItemMaterial.plateLumum), new FluidStack(ModFluids.LumumFluid, 250));

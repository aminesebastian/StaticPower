...
public class FormerRecipes {
	...
	public static void registerFusionRecipes() {
		...
		RegisterHelper.registerFormerRecipes(new ItemStack(ModItems.PlateMould), new MultiOreIngredient("plateTin", "plateCopper", "plateSilver", "plateLead", "plateGold"), CraftHelpers.ingredientOre("plateIron"));	

...
public class SolderingRecipeWrapper extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<IRecipe> {
    ...
    {
        return row >= 0 && row < craftingInvWidth && column >= 0 && column <= craftingInvHeight ? inv.getStackInSlot(row + column * craftingInvWidth) : ItemStack.EMPTY;
    }
    ...
    public static SolderingRecipeWrapper deserialize(JsonObject p_193362_0_)
    {
        ...
        return new SolderingRecipeWrapper(s, i, j, nonnulllist, itemstack);
    }

package theking530.staticpower.blockentities.components.heat;
...
public class HeatStorageComponent extends AbstractBlockEntityComponent implements IHeatStorage {
	...
	protected void checkUpgrades() {
		...
		UpgradeItemWrapper heatUpgrade = upgradeInventory.getMaxTierItemForUpgradeType(UpgradeTypes.HEAT);
		...
		if (!heatUpgrade.isEmpty()) {
			...
			UpgradeItemWrapper heatCapacityUpgrade = upgradeInventory.getMaxTierItemForUpgradeType(UpgradeTypes.HEAT_CAPACITY);

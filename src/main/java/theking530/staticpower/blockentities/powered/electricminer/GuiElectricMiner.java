package theking530.staticpower.blockentities.powered.electricminer;
...
public class GuiElectricMiner extends StaticPowerTileEntityGui<ContainerElectricMiner, BlockEntityElectricMiner> {
	...
	public void initializeGui() {
		...
		registerWidget(new GuiHeatBarFromHeatStorage(getTileEntity().heatStorage, 26, 8, 2, 52));

package theking530.staticpower.blockentities.powered.packager;
...
public class BlockEntityPackager extends BlockEntityMachine {
	...
	public static final BlockEntityTypeAllocator<BlockEntityPackager> TYPE = new BlockEntityTypeAllocator<>((type, pos, state) -> new BlockEntityPackager(pos, state), ModBlocks.Packager);

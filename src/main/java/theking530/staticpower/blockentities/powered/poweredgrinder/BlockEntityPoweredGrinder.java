package theking530.staticpower.blockentities.powered.poweredgrinder;
...
public class BlockEntityPoweredGrinder extends BlockEntityMachine {
	...
	public static final BlockEntityTypeAllocator<BlockEntityPoweredGrinder> TYPE = new BlockEntityTypeAllocator<>((type, pos, state) -> new BlockEntityPoweredGrinder(pos, state), ModBlocks.PoweredGrinder);

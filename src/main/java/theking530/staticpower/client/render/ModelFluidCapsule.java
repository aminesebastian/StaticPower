...
public final class ModelFluidCapsule implements IModel, IModelCustomData, IRetexturableModel {
    ...
    public ModelFluidCapsule(ResourceLocation baseLocation, ResourceLocation liquidLocation, ResourceLocation coverLocation, Fluid fluid, boolean flipGas) {
    ...
    public IBakedModel bake(IModelState state, VertexFormat format,
        ...
        return new BakedFluidCapsule(this, builder.build(), fluidSprite, format, Maps.immutableEnumMap(transformMap), Maps.<String, IBakedModel>newHashMap());
    }
    ...
    public ModelFluidCapsule process(ImmutableMap<String, String> customData)
    {
        ...
        if (customData.containsKey("flipGas"))
        {
            ...
            if (flipStr.equals("true")) flip = true;
                ...
                throw new IllegalArgumentException(String.format("Fluid Capsule custom data \"flipGas\" must have value \'true\' or \'false\' (was \'%s\')", flipStr));
        }
     ...
     * There are 3 layers:
     * base - The empty capsule/container
     ...
     * <p/>
     * If no liquid is given a hardcoded variant for the capsule is used.
     */
    @Override
    ...
    public enum LoaderFluidCapsule implements ICustomModelLoader
    {
        ...
        {
            return modelLocation.getResourceDomain().equals(Reference.MODID) && modelLocation.getResourcePath().contains("fluidCapsule");
        }
    ...
    private static final class BakedFluidCapsuleOverrideHandler extends ItemOverrideList
    {
        public static final BakedFluidCapsuleOverrideHandler INSTANCE = new BakedFluidCapsuleOverrideHandler();
        private BakedFluidCapsuleOverrideHandler()
        {
    ...
    private static final class BakedFluidCapsule implements IPerspectiveAwareModel
    {
        ...
        public BakedFluidCapsule(ModelFluidCapsule parent,

...
public class TileEntityRenderFermenter extends TileEntitySpecialRenderer<TileEntityFermenter> {
	...
	ResourceLocation front = new ResourceLocation(Reference.MOD_ID, "textures/blocks/FermenterOff.png");
	ResourceLocation frontOn = new ResourceLocation(Reference.MOD_ID, "textures/blocks/FermenterOn.png");

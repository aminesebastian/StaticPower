...
public class TileEntityRenderChargingStation extends TileEntitySpecialRenderer<TileEntityChargingStation> {
	...
	ResourceLocation front = new ResourceLocation(Reference.MOD_ID, "textures/blocks/ChargingStationOff.png");
	ResourceLocation frontOn = new ResourceLocation(Reference.MOD_ID, "textures/blocks/ChargingStationOn.png");

...
public class BladeItemModel implements IBakedModel {
	private final IBakedModel baseBladeModel;

	public BladeItemModel(IBakedModel emptyDrillModel) {
	...
	public boolean isAmbientOcclusion() {
		return baseBladeModel.isAmbientOcclusion();
	}
	...
	public boolean isSideLit() {
		return baseBladeModel.isSideLit();
	}

	@Override
	public boolean isBuiltInRenderer() {
		return baseBladeModel.isBuiltInRenderer();
	}

	@Override
	public TextureAtlasSprite getParticleTexture() {
		return baseBladeModel.getParticleTexture();
	}

	protected class BladeWithLayers extends AbstractBakedModel {
		private final ItemStack stack;

		public BladeWithLayers(ItemStack stack, IBakedModel baseBladeModel) {

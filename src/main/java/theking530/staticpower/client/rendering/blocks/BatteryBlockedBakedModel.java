...
public class BatteryBlockedBakedModel extends DefaultMachineBakedModel {
	...
	@Override
	protected void renderQuadsForSide(@Nullable BlockState state, Builder<BakedQuad> newQuads, Direction side, TextureAtlas blocksTexture, BakedQuad originalQuad, MachineSideMode sideConfiguration) {

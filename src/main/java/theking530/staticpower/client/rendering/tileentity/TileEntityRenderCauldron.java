...
public class TileEntityRenderCauldron extends StaticPowerTileEntitySpecialRenderer<TileEntityCauldron> {
	...
	public TileEntityRenderCauldron(BlockEntityRendererProvider.Context context) {
		super(context);
	}

	@Override
	protected void renderTileEntityBase(TileEntityCauldron tileEntity, BlockPos pos, float partialTicks,

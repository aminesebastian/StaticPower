...
public class TileEntityRenderAutoSolderingTable extends StaticPowerTileEntitySpecialRenderer<TileEntityAutoSolderingTable> {
	...
	@Override
	public void renderTileEntityBase(TileEntityAutoSolderingTable tileEntity, BlockPos pos, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int combinedLight,
			int combinedOverlay) {

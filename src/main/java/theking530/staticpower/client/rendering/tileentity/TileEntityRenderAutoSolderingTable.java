...
public class TileEntityRenderAutoSolderingTable extends StaticPowerTileEntitySpecialRenderer<TileEntityAutoSolderingTable> {
	...
	@Override
	public void renderTileEntityBase(TileEntityAutoSolderingTable tileEntity, BlockPos pos, float partialTicks, MatrixStack matrixStack, IRenderTypeBuffer buffer, int combinedLight,
			int combinedOverlay) {
		matrixStack.push();

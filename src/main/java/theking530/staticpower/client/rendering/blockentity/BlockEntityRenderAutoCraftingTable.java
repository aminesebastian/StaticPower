...
import theking530.staticpower.blockentities.machines.autocrafter.BlockEntityAutoCraftingTable;

@OnlyIn(Dist.CLIENT)
public class BlockEntityRenderAutoCraftingTable
		extends StaticPowerBlockEntitySpecialRenderer<BlockEntityAutoCraftingTable> {

	public BlockEntityRenderAutoCraftingTable(BlockEntityRendererProvider.Context context) {
		super(context);
	}

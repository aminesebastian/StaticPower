...
@OnlyIn(Dist.CLIENT)
public class StaticPowerItemRenderer extends ItemRenderer {
	private ItemRenderer parent;

	@Nonnull
	public ItemStack overrideStack;

	public StaticPowerItemRenderer(TextureManager texManager, ModelManager modelManager, ItemColors colors) {
	...
	@Override
	public void renderItem(@Nullable LivingEntity livingEntityIn, ItemStack itemStackIn, ItemCameraTransforms.TransformType transformTypeIn, boolean leftHand, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, @Nullable World worldIn,

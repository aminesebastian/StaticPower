...
public class FakeCraftingInventory extends CraftingInventory {
	...
	public ItemStack getStackInSlot(int index) {
		return index >= this.getSizeInventory() ? ItemStack.EMPTY : this.stackListOverride.get(index);
	}
	...
	public ItemStack removeStackFromSlot(int index) {
		return ItemStackHelper.getAndRemove(this.stackListOverride, index);
	}
	...
	public ItemStack decrStackSize(int index, int count) {
		ItemStack itemstack = ItemStackHelper.getAndSplit(this.stackListOverride, index, count);
		return itemstack;
	}

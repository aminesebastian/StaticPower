...
public class GemOre extends Ore {
	...
	public GemOre(String name, String tool, int level, ItemStack gemDrop, int dropMin, int dropMax, float hardness) {
		super(name, tool, level, hardness);
	...
	/**
	 * Gets the item stack for this block. This is necessary to indicate the item
	 * stack for THIS block as opposed to the item stack that's DROPPED for this
	 * block.
	 */

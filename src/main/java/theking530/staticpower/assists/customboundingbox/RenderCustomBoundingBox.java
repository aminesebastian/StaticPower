...
public class RenderCustomBoundingBox {
	 ...
	 */
	public static void drawSelectionBox(EntityPlayer player, RayTraceResult rayTraceResult, float pTickTime, CustomBoundingBox CustomBoundingBox) {
		...
		if (rayTraceResult.typeOfHit == Type.BLOCK) {
			...
			if (state.getMaterial() != Material.AIR) {
				...
				drawOutlinedBoundingBox(CustomBoundingBox.addExtraSpace(extraSpace).offsetForDraw(-d0, -d1, -d2));
			}
	 ...
	 */
	public static void drawOutlinedBoundingBox(CustomBoundingBox hitbox) {
	...
	public static void addVerticalVertexs(CustomBoundingBox hitbox, BufferBuilder buffer) {
	...
	public static void addTopBottomVertex(CustomBoundingBox hitbox, int side, double sideLength, double heightToAdd, BufferBuilder buffer) {
	...
	public static void addMainVertex(CustomBoundingBox hitbox, int side, double heightToAdd, BufferBuilder buffer) {

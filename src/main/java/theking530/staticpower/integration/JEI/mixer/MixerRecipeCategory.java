package theking530.staticpower.integration.JEI.mixer;
...
public class MixerRecipeCategory extends BaseJEIRecipeCategory<MixerRecipe> {
	...
	public void draw(MixerRecipe recipe, MatrixStack matrixStack, double mouseX, double mouseY) {
		GuiDrawUtilities.drawSlot(matrixStack, 56, 2, 16, 16);
		GuiDrawUtilities.drawSlot(matrixStack, 56, 38, 16, 16);
		...
		GuiDrawUtilities.drawSlot(matrixStack, 100, 23, 24, 8);

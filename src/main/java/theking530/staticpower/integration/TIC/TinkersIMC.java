...
public class TinkersIMC {
	...
	public static void initializeTinkersMaterials() {
	...
	public static void createTinkersMaterial(int ID, ItemStack item, String name, int harvestLevel, int durability, int miningSpeed, int attack, float handlerModifier, String textColor, int color,
	...
	public static void initializeTinkersFluids(){
	...
	public static void createTinkersFluid(int ID, ItemStack meltingItem, Block displayItem, FluidStack fluid, int temperature) {
		NBTTagCompound tag = new NBTTagCompound();

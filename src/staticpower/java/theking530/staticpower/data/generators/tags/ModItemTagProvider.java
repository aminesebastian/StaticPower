...
public class ModItemTagProvider extends ItemTagsProvider {
	...
	protected void addTags() {
		...
		tag(Tags.Items.INGOTS).add(toArray(ModMaterials.MATERIALS.values().stream().filter((bundle) -> bundle.has(MaterialTypes.INGOT)).map((bundle) -> bundle.get(MaterialTypes.INGOT).get())))
				.add(toArray(ModMaterials.MATERIALS.values().stream().filter((bundle) -> bundle.has(MaterialTypes.HEATED_INGOT)).map((bundle) -> bundle.get(MaterialTypes.HEATED_INGOT).get())));
		...
		tag(Tags.Items.NUGGETS).add(toArray(ModMaterials.MATERIALS.values().stream().filter((bundle) -> bundle.has(MaterialTypes.NUGGET)).map((bundle) -> bundle.get(MaterialTypes.NUGGET).get())));
		...
		tag(ModItemTags.WIRES).add(toArray(ModMaterials.MATERIALS.values().stream().filter((bundle) -> bundle.has(MaterialTypes.WIRE)).map((bundle) -> bundle.get(MaterialTypes.WIRE).get())));

		tag(ModItemTags.GEARS).add(toArray(ModMaterials.MATERIALS.values().stream().filter((bundle) -> bundle.has(MaterialTypes.GEAR)).map((bundle) -> bundle.get(MaterialTypes.GEAR).get())));
		...
		tag(Tags.Items.RAW_MATERIALS).add(ModItems.RawRustyIron.get())
				.add(toArray(ModMaterials.MATERIALS.values().stream().filter((bundle) -> bundle.has(MaterialTypes.RAW_MATERIAL)).map((bundle) -> bundle.get(MaterialTypes.RAW_MATERIAL).get())));

		tag(ModItemTags.MATERIALS).addTag(Tags.Items.INGOTS).addTag(Tags.Items.DUSTS).addTag(Tags.Items.RODS).addTag(Tags.Items.GEMS).addTag(Tags.Items.RAW_MATERIALS).addTag(ModItemTags.GEARS)
				.addTag(ModItemTags.PLATES).addTag(ModItemTags.HEATED_INGOTS).add(ModItems.RubberWoodBark.get()).add(ModItems.LatexChunk.get()).add(ModItems.RubberBar.get());

		tag(ModItemTags.BACKPACKS).add(ModItems.Backpack.get(), ModItems.BuildersBackPack.get(), ModItems.DiggersBackPack.get(), ModItems.EngineersBackpack.get(), ModItems.FarmersBackpack.get(),
				ModItems.LumberjacksBackPack.get(), ModItems.MinersBackpack.get(), ModItems.ToolsBackpack.get());

		tag(ModItemTags.COVER_SAW).add(ModItems.IronCoverSaw.get(), ModItems.RubyCoverSaw.get(), ModItems.SapphireCoverSaw.get(), ModItems.DiamondCoverSaw.get(), ModItems.TungstenCoverSaw.get());
		tag(ModItemTags.SOLDERING_IRON).add(ModItems.SolderingIron.get(), ModItems.ElectringSolderingIron.get());
		tag(ModItemTags.MAGNET).add(ModItems.BasicMagnet.get(), ModItems.AdvancedMagnet.get(), ModItems.StaticMagnet.get(), ModItems.EnergizedMagnet.get(), ModItems.LumumMagnet.get());

		tag(ModItemTags.MINING_DRILL).add(ModItems.BasicMiningDrill.get(), ModItems.AdvancedMiningDrill.get(), ModItems.StaticMiningDrill.get(), ModItems.EnergizedMiningDrill.get(),
				ModItems.LumumMiningDrill.get());
		...
		tag(ModItemTags.CHAINSAW).add(ModItems.BasicChainsaw.get(), ModItems.AdvancedChainsaw.get(), ModItems.StaticChainsaw.get(), ModItems.EnergizedChainsaw.get(), ModItems.LumumChainsaw.get());
		tag(ModItemTags.CHAINSAW_BLADE).add(ModItems.IronChainsawBlade.get(), ModItems.BronzeChainsawBlade.get(), ModItems.AdvancedChainsawBlade.get(), ModItems.StaticChainsawBlade.get(),
				ModItems.EnergizedChainsawBlade.get(), ModItems.LumumChainsawBlade.get(), ModItems.TungstenChainsawBlade.get(), ModItems.CreativeChainsawBlade.get());

		tag(ModItemTags.HAMMER).add(ModItems.IronMetalHammer.get(), ModItems.BronzeMetalHammer.get(), ModItems.CopperMetalHammer.get(), ModItems.TinMetalHammer.get(), ModItems.ZincMetalHammer.get(),
		...
		tag(ModItemTags.PORTABLE_BATTERY_PACK).add(ModItems.BasicBatteryPack.get(), ModItems.AdvancedBatteryPack.get(), ModItems.StaticBatteryPack.get(), ModItems.EnergizedBatteryPack.get(),
				ModItems.LumumBatteryPack.get(), ModItems.CreativeBatteryPack.get());
		tag(ModItemTags.FLUID_CAPSULES).add(ModItems.BasicFluidCapsule.get(), ModItems.AdvancedFluidCapsule.get(), ModItems.StaticFluidCapsule.get(), ModItems.EnergizedFluidCapsule.get(),
		...
		tag(ModItemTags.FARMING_SEEDS).addTag(Tags.Items.SEEDS).add(Items.CARROT).add(Items.POTATO).add(ModItems.StaticSeeds.get()).add(ModItems.EnergizedSeeds.get()).add(ModItems.LumumSeeds.get());
		...
		tag(ModItemTags.TOOLS).addTag(ModItemTags.HAMMER).addTag(ModItemTags.MAGNET).addTag(ModItemTags.WIRE_CUTTER).addTag(ModItemTags.MINING_DRILL).addTag(ModItemTags.CHAINSAW)
				.addTag(ModItemTags.PORTABLE_BATTERY).addTag(ModItemTags.PORTABLE_BATTERY_PACK).addTag(ModItemTags.SOLDERING_IRON).addTag(ModItemTags.WRENCH).addTag(ModItemTags.COVER_SAW)
				.addTag(ModItemTags.FLUID_CAPSULES).add(ModItems.Thermometer.get(), ModItems.CableNetworkAnalyzer.get(), ModItems.Multimeter.get(), ModItems.DigistoreWirelessTerminal.get());
		...
		tag(ModItemTags.HUNTER_BACKPACK).addTag(Tags.Items.EGGS).addTag(Tags.Items.LEATHER).addTag(Tags.Items.FEATHERS).addTag(ItemTags.WOOL).add(Items.BEEF).add(Items.CHICKEN).add(Items.PORKCHOP)
				.add(ModItems.RawSmutton.get()).add(ModItems.RawEeef.get()).add(Items.ROTTEN_FLESH);

		tag(ModItemTags.BUILDER_BACKPACK).addTag(ItemTags.STONE_BRICKS).addTag(ItemTags.WALLS).addTag(ItemTags.FENCES).addTag(ItemTags.STAIRS).addTag(Tags.Items.STONE).addTag(Tags.Items.GLASS)
				.addTag(Tags.Items.GLASS_PANES).addTag(Tags.Items.FENCE_GATES);

		tag(ModItemTags.MINER_BACKPACK).addTag(Tags.Items.ORES).addTag(Tags.Items.ORES_IN_GROUND_DEEPSLATE).addTag(Tags.Items.ORES_IN_GROUND_NETHERRACK).addTag(Tags.Items.ORES_IN_GROUND_STONE)
				.addTag(Tags.Items.RAW_MATERIALS).addTag(Tags.Items.GEMS).addTag(ItemTags.COALS).addTag(Tags.Items.DUSTS_GLOWSTONE).addTag(Tags.Items.DUSTS_REDSTONE).addTag(Tags.Items.GEMS_PRISMARINE)
				.addTag(Tags.Items.DUSTS_PRISMARINE);

		tag(ModItemTags.FARMER_BACKPACK).addTag(Tags.Items.CROPS).addTag(Tags.Items.SEEDS);

		tag(ModItemTags.ENGINEER_BACKPACK).addTag(ModItemTags.CABLES).addTag(ModItemTags.PUMPS).addTag(ModItemTags.MACHINES).addTag(ModItemTags.HEATSINKS).addTag(ModItemTags.MACHINE_BLOCKS)
				.addTag(ModItemTags.SOLAR_PANELS).addTag(ModItemTags.TANKS).addTag(ModItemTags.TRANSFORMERS).addTag(ModItemTags.POWER_MANAGEMENT).addTag(ModItemTags.RESISTORS)
				.addTag(ModItemTags.CIRCUIT_BREAKERS);

		tag(ModItemTags.TOOL_BACKPACK).addTag(Tags.Items.TOOLS_PICKAXES).addTag(Tags.Items.TOOLS_SHOVELS).addTag(Tags.Items.TOOLS_AXES).addTag(Tags.Items.TOOLS_HOES).addTag(ModItemTags.TOOLS);

		tag(ModItemTags.HEATED_INGOTS)
				.add(toArray(ModMaterials.MATERIALS.values().stream().filter((bundle) -> bundle.has(MaterialTypes.HEATED_INGOT)).map((bundle) -> bundle.get(MaterialTypes.HEATED_INGOT).get())));

		tag(ModItemTags.WIRE_COILS).add(ModItems.WireCoilDigistore.get())
				.add(toArray(ModMaterials.MATERIALS.values().stream().filter((bundle) -> bundle.has(MaterialTypes.WIRE_COIL)).map((bundle) -> bundle.get(MaterialTypes.WIRE_COIL).get())))

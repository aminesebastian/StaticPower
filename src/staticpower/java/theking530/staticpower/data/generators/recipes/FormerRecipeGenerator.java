...
public class FormerRecipeGenerator extends SCRecipeProvider<FormerRecipe> {
	...
	protected void addRecipe(String nameOverride, StaticPowerIngredient mold, StaticPowerIngredient input, StaticPowerOutputItem output,
		...
		addRecipe(nameOverride, SCRecipeBuilder.create(new FormerRecipe(null, input, mold, output, processing)));
	}
}

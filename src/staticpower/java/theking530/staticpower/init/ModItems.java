...
public class ModItems {
	...
	public static final RegistryObject<PortableBattery> AdvancedPortableBattery = ITEMS.register("portable_battery_advanced",
			() -> new PortableBattery(StaticPowerTiers.ADVANCED));
	public static final RegistryObject<PortableBattery> StaticPortableBattery = ITEMS.register("portable_battery_static",
			() -> new PortableBattery(StaticPowerTiers.STATIC));
	...
	public static final RegistryObject<PortableBattery> CreativePortableBattery = ITEMS.register("portable_battery_creative",
			() -> new PortableBattery(StaticPowerTiers.CREATIVE));

	public static final RegistryObject<Backpack> Backpack = ITEMS.register("backpack", () -> new Backpack(12, StaticPowerAdditionalModels.BACKPACK_OPEN));
	...
	public static final RegistryObject<Backpack> LumberjacksBackPack = ITEMS.register("backpack_lumberjack",
			() -> new Backpack(12, StaticPowerAdditionalModels.LUMBERJACK_BACKPACK_OPEN, ModItemTags.LUMBERJACK_BACKPACK));
	...
	public static final RegistryObject<WireCutters> TungstenWireCutters = ITEMS.register("wire_cutters_tungsten",
			() -> new WireCutters(StaticPowerTiers.TUNGSTEN, () -> ModMaterials.TUNGSTEN.get(MaterialTypes.INGOT).get()));
	...
	public static final RegistryObject<DigistoreIOBusAttachment> IOBusAttachment = ITEMS.register("cable_attachment_digistore_io_bus",
			() -> new DigistoreIOBusAttachment());
	...
	public static final RegistryObject<DigistoreTerminal> DigistoreTerminalAttachment = ITEMS.register("cable_attachment_digistore_terminal",
			() -> new DigistoreTerminal());
	...
	public static final RegistryObject<DigistoreCraftingInterfaceAttachment> DigistoreCraftingInterfaceAttachment = ITEMS
			.register("cable_attachment_digistore_crafting_interface", () -> new DigistoreCraftingInterfaceAttachment());
	...
	public static final RegistryObject<DigistoreWirelessTerminal> DigistoreWirelessTerminal = ITEMS.register("digistore_wireless_terminal",
			() -> new DigistoreWirelessTerminal());
	...
	public static final RegistryObject<ExperienceVacuumUpgrade> ExperienceVacuumUpgrade = ITEMS.register("upgrade_experience_vacuum",
			() -> new ExperienceVacuumUpgrade());
	...
	public static final RegistryObject<BasePowerUpgrade> EnergizedPowerUpgrade = ITEMS.register("upgrade_power_energized",
			() -> new BasePowerUpgrade(StaticPowerTiers.ENERGIZED));
	...
	public static final RegistryObject<BaseSpeedUpgrade> EnergizedSpeedUpgrade = ITEMS.register("upgrade_speed_energized",
			() -> new BaseSpeedUpgrade(StaticPowerTiers.ENERGIZED));
	...
	public static final RegistryObject<BaseRangeUpgrade> EnergizedRangeUpgrade = ITEMS.register("upgrade_range_energized",
			() -> new BaseRangeUpgrade(StaticPowerTiers.ENERGIZED));

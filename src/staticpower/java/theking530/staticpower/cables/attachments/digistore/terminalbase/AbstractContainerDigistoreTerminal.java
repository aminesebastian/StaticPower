...
import theking530.staticcore.container.slots.PlayerArmorItemSlot;
...
public abstract class AbstractContainerDigistoreTerminal<T extends Item> extends AbstractCableAttachmentContainer<T> {
	...
	public AbstractContainerDigistoreTerminal(ContainerTypeAllocator<? extends StaticCoreContainerMenu, ?> allocator, int windowId, Inventory playerInventory, ItemStack attachment,

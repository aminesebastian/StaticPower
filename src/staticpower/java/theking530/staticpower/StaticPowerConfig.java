		...
		public StaticPowerServerConfig(ForgeConfigSpec.Builder builder) {
			builder.push("Generation");
			{
				builder.push("Ore Generation");
				{
					...
					{
						generateZincOre = builder.comment("Disable or Enable Zinc Ore Generation").translation(StaticPower.MOD_ID + ".config." + "generateZincOre").define("GenerateZincOre", true);
						...
						generateLeadOre = builder.comment("Disable or Enable Lead Ore Generation").translation(StaticPower.MOD_ID + ".config." + "generateLeadOre").define("GenerateLeadOre", true);
						generateSilverOre = builder.comment("Disable or Enable Silver Ore Generation").translation(StaticPower.MOD_ID + ".config." + "generateSilverOre").define("GenerateSilverOre",
								true);
						...
						generateRubyOre = builder.comment("Disable or Enable Ruby Ore Generation").translation(StaticPower.MOD_ID + ".config." + "generateRubyOre").define("GenerateRubyOre", true);
					...
					builder.push("Deep");
					{
						generateDeepslateZincOre = builder.comment("Disable or Enable Deepslate Zinc Ore Generation").translation(StaticPower.MOD_ID + ".config." + "generateDeepslateZincOre")
						...
						generateDeepslateTinOre = builder.comment("Disable or Enable Deepslate Tin Ore Generation").translation(StaticPower.MOD_ID + ".config." + "generateDeepslateTinOre")
								.define("GenerateDeepslateTinOre", true);
						generateDeepslateLeadOre = builder.comment("Disable or Enable Deepslate Lead Ore Generation").translation(StaticPower.MOD_ID + ".config." + "generateDeepslateLeadOre")
								.define("GenerateDeepslateLeadOre", true);
						generateDeepslateSilverOre = builder.comment("Disable or Enable Deepslate Silver Ore Generation").translation(StaticPower.MOD_ID + ".config." + "generateDeepslateSilverOre")
						...
						generateDeepslateRubyOre = builder.comment("Disable or Enable Deepslate Ruby Ore Generation").translation(StaticPower.MOD_ID + ".config." + "generateDeepslateRubyOre")
								.define("GenerateDeepslateRubyOre", true);
					}
					builder.pop();
					builder.push("Nether");
					{
						generateNetherSilverOre = builder.comment("Disable or Enable Nether Silver Ore Generation").translation(StaticPower.MOD_ID + ".config." + "generateNetherSilverOre")
								.define("GenerateNetherSilverOre", true);
						generateNetherPlatinumOre = builder.comment("Disable or Enable Nether Platinum Ore Generation").translation(StaticPower.MOD_ID + ".config." + "generateNetherPlatinumOre")
								.define("GenerateNetherPlatinumOre", true);
						generateNetherTungstenOre = builder.comment("Disable or Enable Nether Tungsten Ore Generation").translation(StaticPower.MOD_ID + ".config." + "generateNetherTungstenOre")
			...
			builder.push("Machines");
			{
				...
				}
				{
					...
					electricMinerHeatGeneration = builder.comment("Defines how much heat is produced when a block is broken by an electric miner.")
							.translation(StaticPower.MOD_ID + ".config." + "electricMinerHeatGeneration").define("ElectricMinerHeatGeneration", CapabilityHeatable.convertHeatToMilliHeat(100));
...

				{
					...
					autoCrafterPowerUsage = builder.comment("Controls how much power is used per tick in this machine (in SW).").translation(StaticPower.MOD_ID + ".config." + "autoCrafterPowerUsage")
				...
				}
				{
					...
					basicFarmerPowerUsage = builder.comment("Controls how much power is used per tick in this machine (in SW).").translation(StaticPower.MOD_ID + ".config." + "basicFarmerPowerUsage")
				...
				}
				{
					...
					crucibleHeatGenerationPerTick = builder.comment("Controls the amount of heat that is generated per tick for in the Crucible.")
							.translation(StaticPower.MOD_ID + ".config." + "crucibleHeatGenerationPerTick").define("CrucibleHeatGenerationPerTick", CapabilityHeatable.convertHeatToMilliHeat(5));
					builder.pop();
				}
				{
				...
				}
				{
					...
					alloyFurnaceProcessingTime = builder
							.comment("Controls how much time it takes to processing an alloy furnace (in ticks [1 Second = 20 Ticks]). Individual recipes can override this value.")
							.translation(StaticPower.MOD_ID + ".config." + "alloyFurnaceProcessingTime").define("AlloyFurnaceProcessingTime", 400);
					builder.pop();
				}
				{
				...
				{
					builder.push("Pump");
					pumpPowerUsage = builder.comment("Controls how much power is used per pump action in this machine (in SW).").translation(StaticPower.MOD_ID + ".config." + "pumpPowerUsage")
							.define("PumpPowerUsage", 100.0);
					pumpTankCapacity = builder.comment("How many mB of fluid a pump can contain.").translation(StaticPower.MOD_ID + ".config." + "pumpTankCapacity").define("PumpTankCapacity", 5000);
					builder.pop();
				}
				{
				...
				}
				{
					...
					hydroponicFarmerProcessingTime = builder
							.comment("Controls how much time it takes to processing a recipe in this machine (in ticks [1 Second = 20 Ticks]). Individual recipes can override this value.")
				...
				}
				{
					...
					refineryPerBoilerHeatGeneration = builder.comment("Defines how much heat (in mC [1C = 1000mC]) is produced by the refinery per tick ([1 Second = 20 Ticks]).")
							.translation(StaticPower.MOD_ID + ".config." + "refineryHeatGeneration").define("RefineryHeatGeneration", CapabilityHeatable.convertHeatToMilliHeat(10));
					...
					refineryOverheatCooldownTime = builder.comment("Defines how long it takes (in ticks [1 Second = 20 Ticks]) after a refinery has overheated to start processing again.")
			...
			builder.push("Items");
			drillPowerUsePerBlock = builder.comment("The amount of power used to mine a single block by a drill.").translation(StaticPower.MOD_ID + ".config." + "drillPowerUsePerBlock")
					.define("DrillPowerUsePerBlock", 10.0);

			chainsawPowerUsePerBlock = builder.comment("The amount of power used to mine a single block by a chainsaw.").translation(StaticPower.MOD_ID + ".config." + "chainsawPowerUsePerBlock")

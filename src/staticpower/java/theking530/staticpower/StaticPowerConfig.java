		...
		public StaticPowerServerConfig(ForgeConfigSpec.Builder builder) {
			...
			builder.push("Machines");
			{
				...
				}
				{
					...
					pumpTankCapacity = builder.comment("How many mB of fluid a pump can contain.").translation(StaticPower.MOD_ID + ".config." + "pumpTankCapacity")
			...
			drillPowerUsePerBlock = builder.comment("The amount of power used to mine a single block by a drill.")
					.translation(StaticPower.MOD_ID + ".config." + "drillPowerUsePerBlock").define("DrillPowerUsePerBlock", 10.0);

			chainsawPowerUsePerBlock = builder.comment("The amount of power used to mine a single block by a chainsaw.")
					.translation(StaticPower.MOD_ID + ".config." + "chainsawPowerUsePerBlock").define("ChainsawPowerUsePerBlock", 10.0);
			builder.pop();
		}
	}

...
public class ModelSmeepFur extends QuadrupedModel<EntitySmeep> {
	private float headXRot;

	public ModelSmeepFur(ModelPart p_170900_) {
	...
	public void prepareMobModel(EntitySmeep p_103661_, float p_103662_, float p_103663_, float p_103664_) {
	...
	public void setupAnim(EntitySmeep p_103666_, float p_103667_, float p_103668_, float p_103669_, float p_103670_,
			float p_103671_) {

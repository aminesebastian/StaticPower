...
public class AnvilForgeEntityType extends AbstractEntityBuilder<AnvilForgeEntity> {

	public AnvilForgeEntityType() {
		super(EntityType.Builder.<AnvilForgeEntity>of(AnvilForgeEntity::new, MobCategory.MISC).sized(0.25F, 0.25F).clientTrackingRange(6).updateInterval(20));
	}

...
public class ContainerPoweredFurnace extends StaticPowerTileEntityContainer<BlockEntityPoweredFurnace> {
	...
	public ContainerPoweredFurnace(int windowId, Inventory inv, FriendlyByteBuf data) {
		this(windowId, inv, (BlockEntityPoweredFurnace) resolveTileEntityFromDataPacket(inv, data));
	}

	public ContainerPoweredFurnace(int windowId, Inventory playerInventory, BlockEntityPoweredFurnace owner) {

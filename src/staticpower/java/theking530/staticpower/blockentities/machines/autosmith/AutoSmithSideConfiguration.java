...
public class AutoSmithSideConfiguration extends DefaultMachineNoFacePreset {
	public static final AutoSmithSideConfiguration INSTANCE = new AutoSmithSideConfiguration();

	public AutoSmithSideConfiguration() {

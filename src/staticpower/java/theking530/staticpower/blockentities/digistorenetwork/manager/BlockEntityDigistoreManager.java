...
public class BlockEntityDigistoreManager extends BlockEntityDigistoreBase {
	...
	public BlockEntityDigistoreManager(BlockPos pos, BlockState state) {
		...
		registerComponent(energyStorage = new TieredPowerStorageComponent("MainEnergyStorage", StaticPowerTiers.ENERGIZED, true, false).setUpgradeInventory(upgradesInventory));

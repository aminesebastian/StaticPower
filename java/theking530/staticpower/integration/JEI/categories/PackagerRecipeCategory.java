...
public class PackagerRecipeCategory extends BaseJEIRecipeCategory<PackagerRecipe> {
	...
	public void setRecipe(IRecipeLayoutBuilder builder, PackagerRecipe recipe, IFocusGroup ingredients) {
		builder.addSlot(RecipeIngredientRole.INPUT, 79, 22).addIngredients(recipe.getInputIngredient().getIngredient());
		builder.addSlot(RecipeIngredientRole.OUTPUT, 29, 21).addIngredient(PluginJEI.PROBABILITY_ITEM_STACK, recipe.getOutput());

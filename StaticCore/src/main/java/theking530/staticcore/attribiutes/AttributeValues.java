...
public class AttributeValues {
	private static final DeferredRegister<AttributeValueType<?>> ATTRIBUTE_VALUES = DeferredRegister.create(StaticCoreRegistries.ATTRIBUTE_VALUE_TYPE, StaticCore.MOD_ID);

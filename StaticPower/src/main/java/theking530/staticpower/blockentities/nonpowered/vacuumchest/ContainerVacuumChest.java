...
public class ContainerVacuumChest extends StaticPowerTileEntityContainer<BlockEntityVacuumChest> {
	...
	public ContainerVacuumChest(int windowId, Inventory inv, FriendlyByteBuf data) {
		this(windowId, inv, (BlockEntityVacuumChest) resolveTileEntityFromDataPacket(inv, data));
	}

	public ContainerVacuumChest(int windowId, Inventory playerInventory, BlockEntityVacuumChest owner) {

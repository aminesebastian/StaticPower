...
public abstract class StaticPowerTier extends StaticCoreTier {
	/****************
	 * Tier Settings
	 ****************/
	...
	public StaticPowerTier(ForgeConfigSpec.Builder builder) {
		...
		defaultMachineOverheatTemperature = builder.comment("The temperature at which a machine of this tier overheats and stops processing (in mC [1C = 1000mC]).")
				.translation(StaticPower.MOD_ID + ".config." + "defaultMachineOverheatTemperature").define("DefaultMachineOverheatTemperature", getDefaultMachineOverheatTemperature());
		defaultMachineMaximumTemperature = builder.comment("The maximum amount of heat a machine of this tier can contain (in mC [1C = 1000mC]).")
				.translation(StaticPower.MOD_ID + ".config." + "defaultMachineMaximumTemperature").define("DefaultMachineMaximumTemperature", getDefaultMachineMaximumTemperature());
		defaultTankCapacity = builder.comment("The base amount of fluid a machine of this tier can store (in mB [1B = 1000mB]).").translation(StaticPower.MOD_ID + ".config." + "defaultTankCapacity")
		...
		heatSinkMaximumTemperature = builder.comment("The temperature above which this heatsink will be destroyed.").translation(StaticPower.MOD_ID + ".config." + "heatSinkMaximumTemperature")

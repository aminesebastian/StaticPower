...
public class ModUpgradeTypes {
	private static final DeferredRegister<UpgradeType<?>> UPGRADE_TYPE_REGISTRY = DeferredRegister.create(StaticCoreRegistries.UPGRADE_TYPES_REGISTRY_KEY, StaticPower.MOD_ID);

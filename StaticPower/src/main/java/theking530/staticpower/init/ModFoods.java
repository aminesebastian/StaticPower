...
public class ModFoods {
	public static final FoodProperties STATIC_FRUIT = (new FoodProperties.Builder()).nutrition(3).saturationMod(0.3F).alwaysEat().effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 80, 2), 1.0f).build();
	public static final FoodProperties ENERGIZED_FRUIT = (new FoodProperties.Builder()).nutrition(6).saturationMod(0.5F).alwaysEat().effect(() -> new MobEffectInstance(MobEffects.JUMP, 80, 2), 1.0f).build();
	public static final FoodProperties LUMUM_FRUIT = (new FoodProperties.Builder()).nutrition(9).saturationMod(0.9F).alwaysEat().effect(() -> new MobEffectInstance(MobEffects.REGENERATION, 80, 2), 1.0f).build();

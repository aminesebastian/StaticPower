...
import theking530.staticcore.utilities.string.StringUtilities;
...
public class GuiCraftingAmount extends StaticPowerContainerScreen<ContainerCraftingAmount> {
	...
	public SpriteDrawable missingIngredientDrawable = new SpriteDrawable(StaticCoreSprites.ERROR, 8, 8);
	...
	public void initializeGui() {
		...
		missingIngredientDrawable = new SpriteDrawable(StaticCoreSprites.ERROR, 16, 16);

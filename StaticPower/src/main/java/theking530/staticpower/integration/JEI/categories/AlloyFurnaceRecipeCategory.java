...
public class AlloyFurnaceRecipeCategory extends BaseJEIRecipeCategory<AlloyFurnaceRecipe> {
	...
	public AlloyFurnaceRecipeCategory(IGuiHelper guiHelper) {
		super(guiHelper);
		locTitle = Component.translatable(ModBlocks.AlloyFurnace.get().getDescriptionId());
	...
	@Override
	public void draw(AlloyFurnaceRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack matrixStack, double mouseX, double mouseY) {
	...
	@Override
	public List<Component> getTooltipStrings(AlloyFurnaceRecipe recipe, IRecipeSlotsView recipeSlotsView, double mouseX, double mouseY) {
